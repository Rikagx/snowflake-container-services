...
-- too permissive; would need to change for prod and testing
...
CALL SYSTEM$GET_SERVICE_LOGS('NAE_APP.services.workbench', '0', 'container', 1000);
-- if name of container from spec.yaml file changes